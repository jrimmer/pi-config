...
**Never assume the comment is already addressed or stale.** Always fetch the current state of the thread and the PR before deciding. CI re-runs on every push and can post new comments between any two turns.
